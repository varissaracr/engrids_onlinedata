...
-- Started on 2022-11-24 16:03:28 +07
...
--
-- TOC entry 4540 (class 1262 OID 16384)
...
-- Name: geodb; Type: DATABASE PROPERTIES; Schema: -; Owner: postgres
--

ALTER DATABASE geodb SET search_path TO '$user', 'public', 'topology', 'tiger';
