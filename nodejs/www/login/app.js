...
let setCookie = (code, firstname_TH, lastname_TH, student_id, organization_name_TH, auth, minute) => {
    const d = new Date();
...
if (code) {
    axios.post('/ds_chekauth/gettoken', { code }).then(r => {
        console.log(r);
        setCookie(code, r.data.data.firstname_TH, r.data.data.lastname_TH, r.data.data.student_id, r.data.data.organization_name_TH, r.data.auth, 2)
